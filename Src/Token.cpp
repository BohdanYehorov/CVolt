...
namespace Volt
{
	std::string Token::ToString(const CompilationContext &Context) const
	{
		...
		switch (Type)
		{
			...
			GEN_CASE_TO_STRING(I8_NUMBER)
			GEN_CASE_TO_STRING(I16_NUMBER)
			GEN_CASE_TO_STRING(I32_NUMBER)
			GEN_CASE_TO_STRING(I64_NUMBER)
			GEN_CASE_TO_STRING(U8_NUMBER)
			GEN_CASE_TO_STRING(U16_NUMBER)
			GEN_CASE_TO_STRING(U32_NUMBER)
			GEN_CASE_TO_STRING(U64_NUMBER)
			GEN_CASE_TO_STRING(F16_NUMBER)
			GEN_CASE_TO_STRING(F32_NUMBER)
			GEN_CASE_TO_STRING(F64_NUMBER)
			GEN_CASE_TO_STRING(F128_NUMBER)
			...
			GEN_CASE_TO_STRING(KW_CLASS)
			GEN_CASE_TO_STRING(TYPE_CONST)
			GEN_CASE_TO_STRING(TYPE_VOID)
			GEN_CASE_TO_STRING(TYPE_BOOL)
			GEN_CASE_TO_STRING(TYPE_CHAR)
			GEN_CASE_TO_STRING(TYPE_I8)
			GEN_CASE_TO_STRING(TYPE_I16)
			GEN_CASE_TO_STRING(TYPE_I32)
			GEN_CASE_TO_STRING(TYPE_I64)
			GEN_CASE_TO_STRING(TYPE_U8)
			GEN_CASE_TO_STRING(TYPE_U16)
			GEN_CASE_TO_STRING(TYPE_U32)
			GEN_CASE_TO_STRING(TYPE_U64)
			GEN_CASE_TO_STRING(TYPE_F16)
			GEN_CASE_TO_STRING(TYPE_F32)
			GEN_CASE_TO_STRING(TYPE_F64)
			GEN_CASE_TO_STRING(TYPE_F128)
